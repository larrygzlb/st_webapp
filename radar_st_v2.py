...
attributes_raw = {
    "Strength": st.sidebar.selectbox("Strength", ["Low", "Medium", "High"], index=2),
    "Agility": st.sidebar.selectbox("Agility", ["Low", "Medium", "High"], index=1),
    "Intelligence": st.sidebar.selectbox("Intelligence", ["Low", "Medium", "High"], index=2),
    "Charisma": st.sidebar.selectbox("Charisma", ["Low", "Medium", "High"], index=1),
    "Endurance": st.sidebar.selectbox("Endurance", ["Low", "Medium", "High"], index=2),
}
attributes = {k: level_to_value[v] for k, v in attributes_raw.items()}
